<%-- 
    Document   : perguntasAbertas
    Created on : 10/05/2017, 10:46:27
    Author     : Matheus Levi
--%>
...
<html>
    <head>
	 <title>Fórum do Programador - Perguntas por Linguagem de Programação</title>
         <meta charset="utf-8">
	 <meta name="viewport" content="width=device-width, initial-scale=1">
	 <link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css">
	 <link href="http://fonts.googleapis.com/css?family=Lato" rel="stylesheet" type="text/css">
	 <link href="http://fonts.googleapis.com/css?family=Montserrat" rel="stylesheet" type="text/css">
         <link rel="stylesheet" href="estilos/perguntasLP.css"> 
	 <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.0/jquery.min.js"></script>
	 <script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>
         <script src="js/loadNavbar.js"></script> 
         <script src="js/perguntasLP.js"></script>
	</head>
        <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50" onload="carregarPerguntasLP('<%=id %>'); carregarLinguagemProgramacaoNav();">
            <div class="wrapper">
                ...
                <div id="PerguntaContainer" class="container-fluid col-sm-12">
                    <div class="col-sm-12 text-center PerguntaHeader" id="lpTitulo" >
					<!---->P
                    </div>
